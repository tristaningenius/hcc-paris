    ...
    <Section gap="large">
      ...
      <div>
        ...
        <ul className="mt-4 list-disc pl-8 text-trans-70">
          ...
          <li>
            Profiter de notre programme de fidélité : un code de réduction de 5
            € à 20 € en cumulant des points.
          </li>
        </ul>
      </div>
      <Section
        ...
        <div className="flex flex-col justify-between gap-8">
          <div>
            <p className="max-w-[50rem] text-xl sm:text-2xl">
              Inscrivez-vous simplement chez HHC Paris pour profiter de notre
              excellent programme de fidélité.
            </p>
          </div>
          <h4 className="text-xl sm:text-2xl">
            1 € dépensé = 1 point, nos avantages :{' '}
          </h4>
