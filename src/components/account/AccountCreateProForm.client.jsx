...
export function AccountCreateProForm() {
  ...
  return (
    <Section gap="large" maxW className="w-full">
      ...
      <div>
        Ce formulaire est destiné aux professionnels qui souhaitent créer un
        compte pro afin d&apos;accéder aux tarifs grossiste.
      </div>
      ...
      <form className="flex flex-col gap-2" noValidate onSubmit={onSubmit}>
        ...
        {!passwordError ? (
          ...
          <ErrorsLabel>{passwordError} &nbsp;</ErrorsLabel>
        )}
        ...
        <div>
          Disposez-vous d&apos;un compte particulier et souhaitez-vous le
          transformer en compte pro? &nbsp;
