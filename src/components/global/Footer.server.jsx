import {LogoText} from '../elements/AssetImport';
import {Button, LogoStar} from '~/components';

export function Footer({promoMessage}) {
  const {
  ...
  return (
    <footer className="mt-16 border-t">
      {JSON.parse(isActive) ? <FooterBanner message={message} /> : null}
...
function FooterBanner({message}) {
  return (
    <aside className="wrapper">
      <div className="marquee bg-neutral-600 pt-4 pb-3 font-display text-4xl uppercase text-tertiary-100 lg:pb-5 lg:pt-6 lg:text-6xl">
