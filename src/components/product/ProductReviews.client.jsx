        ...
        <div className="w-full max-w-2xl grow">
          {reviews ? (
            <ul>
              {reviews?.map((review) => {
                return (
                  <li
                    key={review.id}
                    className="flex gap-2 border-b border-trans-20 py-4"
                  >
                    <div>
                      <div className="flex h-12 w-12 select-none items-center justify-center rounded-full bg-neutral-600 pt-1 font-display text-3xl text-tertiary-100">
            ...
            <p className="text-center">
              Pour le moment il n&apos;y a aucun avis vérifié sur ce produit
            </p>
          )}
        </div>
      </div>
